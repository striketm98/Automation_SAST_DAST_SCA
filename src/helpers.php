...
function sampleDashboard(): array
{
    return [
        ...
        'findings' => [
            ['severity' => 'critical', 'status' => 'open', 'cwe_id' => 'CWE-78', 'ai_summary' => 'Likely command injection path with direct process execution.', 'ai_confidence' => 91, 'title' => 'Remote code execution pattern', 'category' => 'SAST', 'file_path' => 'app/services/parser.php', 'line_number' => 131, 'description' => 'Untrusted content is passed into a dynamic evaluator.', 'recommendation' => 'Remove the evaluator and replace it with a safe parser.'],
            ['severity' => 'high', 'status' => 'open', 'cwe_id' => 'CWE-352', 'ai_summary' => 'Missing anti-forgery controls on a state-changing form.', 'ai_confidence' => 88, 'title' => 'Missing CSRF protection', 'category' => 'DAST', 'file_path' => 'views/profile.php', 'line_number' => 42, 'description' => 'State-changing form does not include a CSRF token.', 'recommendation' => 'Add a CSRF token and verify it server-side.'],
            ['severity' => 'medium', 'status' => 'false_positive', 'cwe_id' => 'CWE-200', 'ai_summary' => 'External package risk appears informational and should be manually confirmed.', 'ai_confidence' => 74, 'title' => 'Outdated dependency', 'category' => 'SCA', 'file_path' => 'composer.lock', 'line_number' => null, 'description' => 'A third-party package includes a known medium-risk vulnerability.', 'recommendation' => 'Upgrade to a patched version and re-run dependency analysis.'],
        ],
    ];
}
